...
pago = 2400
inaceptable = float(0.0)
aceptable = float(0.4)
meritorio = float(0.6)
puntos = float(input("Introduce tu puntuación: "))
if puntos == inaceptable:
    print(f"Tu rendimiento fue {puntos}, por lo tanto no tienes rendimientos. ")
elif puntos == aceptable:
    print(f"Tu rendimiento fue {puntos}, por lo tanto tus rendimientos son {pago*puntos} ")
elif puntos >= 0.6:
    print(f"Tu rendimiento fue {puntos}, por lo tanto tus rendimientos son {pago*puntos} ")
else:
