...
Ejercicio 2
Escribir un programa que pregunte el nombre completo del usuario en la c
onsola y después muestre por pantalla el nombre completo del usuario tres 
...
número de teléfono con este formato y muestre por pantalla el número de 
